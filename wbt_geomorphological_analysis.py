...
def GeomorphologicalFluvialFloodHazardAreas():
...
def SteepAreas(dem, threshold, slope_output, raster_output, polygon_output, delete_temp_outputs=True):
    ...
    if delete_temp_outputs:
        ...
        os.remove(os.path.join(wbt.work_dir,slope_output))